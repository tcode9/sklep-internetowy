        ...
        <div class="col-md-3">
            <div class="tile p-0">
                <ul class="nav flex-column nav-tabs user-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#values" data-toggle="tab">Wartość cechy</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9">
                ...
                <div class="tab-pane active" id="general">
                    <div class="tile">
                        <form action="{{ route('admin.attributes.update') }}" method="POST" role="form">
                            @csrf
                            <h3 class="tile-title">Informacje</h3>
                            <hr>
                            <div class="tile-body">
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('admin.attributes.index') }}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Wroć</a>
                                    </div>
                                </div>
                            </div>
                        </form>
