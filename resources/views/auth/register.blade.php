...
@section('content')
    <section class="section-pagetop bg-dark">
        <div class="container clearfix">
            <h2 class="title-page">Rejestracja</h2>
        </div>
    </section>
                ...
                <div class="card">
                    ...
                    <article class="card-body">
                        <form action="{{ route('register') }}" method="POST" role="form">
                            ...
                            <small class="text-muted">Klikając przycisk "zarejestruj" akceptujesz <br> regulamin i politykę prywatności naszej firmy.</small>
                        </form>
                    </article>
                    <div class="border-top card-body text-center">Posiadasz konto? <a href="{{ route('login') }}">Zaloguj się</a></div>
                </div>
            </div>
        </div>
    </section>
